          ...
          <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            ...
            <div class="overflow-x-auto">
              <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                  <tr class="border-b dark:border-gray-700 text-white">
                    <th scope="row" class="px-4 py-3 ">
                      Rrezon
                    </th>
                    <td class="px-4 py-3">Krasniqi</td>
                    <td class="px-4 py-3">rrezonkrasniqi32@gmail.com</td>
                    <td class="px-4 py-3">+383 49 155 083</td>
          ...
          <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            <div class="flex justify-between mb-4 rounded-t sm:mb-5">
              <div class="text-lg text-gray-900 md:text-xl dark:text-white">
                <h3 class="font-semibold ">Rrezon Krasniqi</h3>
